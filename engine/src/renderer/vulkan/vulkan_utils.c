// i just copied and pasted this from his repo, cause looks like ke also did that from vulkan, if i need to learn this i will
// yes he did/ google vk codes if i need to find this stuff

#include "vulkan_utils.h"

// one note, if get extended is false you get the first short message, if true you get the longer more detailed message
